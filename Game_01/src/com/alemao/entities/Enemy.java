...
public class Enemy extends Entity {
	...
	public Enemy(int x, int y, int width, int height, BufferedImage sprite) {
		...
		leftEnemy[0] = Game.spritesheet.getSprite(80, 16 + 16, 16, 16);
		leftEnemy[1] = Game.spritesheet.getSprite(96, 16 + 16, 16, 16);
		leftEnemy[2] = Game.spritesheet.getSprite(144, 16 + 32, 16, 16);
		
		rightEnemy[0] = Game.spritesheet.getSprite(112, 16 + 16, 16, 16);
		rightEnemy[1] = Game.spritesheet.getSprite(128, 16 + 16, 16, 16);
		rightEnemy[2] = Game.spritesheet.getSprite(144, 0 + 32, 16, 16);
	}
	...
	public void render(Graphics g) {
		if(!isDamaged) {
			...
			if(dir == right_dir) {
				g.drawImage(rightEnemy[2],this.getX() - Camera.x,this.getY() -  Camera.y,null);
			}else if(dir == left_dir) {
				g.drawImage(leftEnemy[2],this.getX() - Camera.x,this.getY() -  Camera.y,null);
			}
		}
