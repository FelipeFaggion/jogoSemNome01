...
import com.alemao.entities.BulletShoot;
import com.alemao.entities.Enemy;
import com.alemao.entities.Entity;
import com.alemao.entities.Player;
import com.alemao.graficos.Spritesheet;
import com.alemao.graficos.UI;
...
public class Game extends Canvas implements Runnable, KeyListener, MouseListener{
	...
	public void tick() {
		if(gameState == "NORMAL") {
			...
			//System.out.println("Fim de jogo campeao");
			framesGameOver++;
	...
	public void render() {
		...
		if(gameState == "GAME_OVER") {
			...
			if(showMessageGameOver){
				g.drawString(">Enter para Reiniciar<", ((WIDTH*SCALE)/2 - 155),((HEIGHT*SCALE)/2) + 40);
			}
		}else if(gameState == "MENU") {
			menu.render(g);
		}
